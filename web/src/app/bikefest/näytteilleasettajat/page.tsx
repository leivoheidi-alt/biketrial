...
export default async function BikefestPartnersPage() {
  ...
  const benefitCards = [
    {
      title: 'Kasvu',
      body: 'Tapahtuma rakentaa vuosittain vahvempaa roolia Hämeenlinnassa.',
      icon: 'growth',
    },
    {
      title: 'Yleisö',
      body: 'Perheet, nuoret, harrastajat ja aktiivinen vapaa-ajan yleisö samassa päivässä.',
      icon: 'audience',
    },
    {
      title: 'Kohtaaminen',
    ...
    {
      title: 'Sisältö',
      body: 'Show, kilpailu ja yleisö tuottavat materiaalia markkinointiin.',
      icon: 'content',
    },
  ...
  const packageCards: PackageCard[] = [
    ...
    },
    {
      ...
      items: [
        'Hyvä sijainti',
        'Näkyvyys ennakossa / sivuilla',
        'Ständi + markkinointituki',
      ],
      ctaLabel: 'Kysy lisää',
      ctaHref: exhibitorBookingMail,
      featured: true,
    ...
    <>
      <section className="relative overflow-hidden bg-black">
        ...
        <div className="relative z-10 mx-auto max-w-[1280px] px-5 py-20 sm:px-6 sm:py-24 lg:px-8">
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_440px] lg:items-center lg:gap-12">
            <div className="max-w-[840px]">
              ...
              <p className="max-w-[640px] text-[1.18rem] leading-[1.58] text-[#B0B0B0] sm:text-[1.24rem]">
                Liity BikeFestin näytteilleasettajiin ja kohtaa yleisö
                ympäristössä, jossa tuotteet, palvelut ja kohtaamiset tuntuvat
                oikeilta.
              </p>
            ...
            <aside className="border-l-[6px] border-[#FF6A00] bg-[#1A1A1A] px-7 py-8">
              <div
                className="mb-7 text-[1.72rem] uppercase leading-[1.04] text-white"
                style={{
                  fontFamily: 'var(--font-montserrat), var(--font-anton), Impact, sans-serif',
                  letterSpacing: '-0.03em',
                }}
              >
                Näytteilleasettajalle nopeasti
              </div>

              <div className="space-y-8">
                <div className="border-b border-white/12 pb-7">
                  <div className="mb-2 text-[1.7rem] font-black leading-none text-[#FF6A00]">
                    Ständit
                  </div>
                  <div className="text-[0.9rem] uppercase tracking-[0.04em] text-[#B0B0B0]">
                    esittelyyn, myyntiin ja demoihin
                  </div>
                </div>
                ...
                <div className="border-b border-white/12 pb-7">
                  ...
                  <div className="text-[0.9rem] uppercase tracking-[0.04em] text-[#B0B0B0]">
                    brändeille, jotka haluavat osallistavaa näkyvyyttä
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="text-[0.9rem] uppercase tracking-[0.04em] text-[#B0B0B0]">
                    paikallinen yleisö, perheet ja harrastajat
                  </div>
                </div>
              </div>
            </aside>
      ...
      <section className="bg-[#050505] py-[100px]">
        <div className="section-container">
        ...
        <div className="section-container" id="paketit">
          <div className="mx-auto mb-14 max-w-[880px] text-center">
            ...
            <p className="mx-auto mt-5 max-w-[760px] text-[1.08rem] leading-[1.7] text-[#B8B8B8] sm:text-[1.16rem]">
              ...
              paikat sovitaan tapahtumaan sopiviksi toimijan tarpeen mukaan.
            </p>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-[30px] lg:grid-cols-3">
            {packageCards.map((item) => (
              ...
              >
                ...
                <h3
                  className="text-[1.6rem] uppercase text-white"
                  style={{
                    fontFamily: 'var(--font-montserrat), var(--font-anton), Impact, sans-serif',
                    letterSpacing: '-0.03em',
                  }}
                ...
                {item.summary ? (
                  <p className="mb-6 text-[1rem] leading-[1.65] text-[#C8C8C8]">
                    {item.summary}
                  </p>
                ) : null}
                ...
                <ul className="mb-0 space-y-3 text-[#B0B0B0]">
                  {item.items.map((point) => (
                    <li key={point} className="relative pl-5 text-[1rem] leading-[1.6]">
      ...
      <section className="mt-[100px] bg-[linear-gradient(135deg,#ff6a00_0%,#ff8c00_100%)] px-5 py-[100px] text-center">
        <div className="section-container">
          <h2
